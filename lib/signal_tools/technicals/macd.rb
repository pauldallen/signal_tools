module YquotesSignalTools
  module Technicals
    class MACD
      ...
      def macd_points
        fast_ema_points = YquotesSignalTools::Technicals::EMA.new(data, fast).calculate
        slow_ema_points = YquotesSignalTools::Technicals::EMA.new(data, slow).calculate
      ...
      def macd_and_divergence_points(fast_ema_points, slow_ema_points)
        ...
        signal_points = YquotesSignalTools::Technicals::EMA.new(macds, signal).calculate
